...
IMAGES_DIR="/BS/generative_modelling_for_image_understanding/nobackup/data/DETECTRON2_DATASETS/lvis/train2017"
ANN_FILE="/BS/generative_modelling_for_image_understanding/nobackup/data/DETECTRON2_DATASETS/lvis/annotations/lvis_v1_train.json"

OUT_DIR="./augmented_dataset/out/lvis_sam_lama_all_full"
SPLIT="train2017"
