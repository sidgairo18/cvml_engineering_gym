#!/bin/bash
#SBATCH -D ./
#SBATCH -J 0.5bllava_coco_atypical_array
#SBATCH -t 4:00:00
...
IMG_DIR="/BS/generative_modelling_for_image_understanding/nobackup/data/DETECTRON2_DATASETS/coco/train2017"
...
OUT_JSONL="outputs/shards/atypical_llava0.5b_two_gated_shard_${SLURM_ARRAY_TASK_ID}.jsonl"
